<div class="p-6 bg-white dark:bg-gray-800 rounded-lg shadow-md">
    <div class="mb-6">
        <h2 class="text-xl font-semibold text-gray-900 dark:text-white mb-4">Metrics Trend Visualization</h2>
        
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
            <!-- Node Selection -->
            <div>
                <label for="node-select" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Node</label>
                <select 
                    id="node-select" 
        ...
        @elseif(empty($chartData) || empty($chartData['labels'] ?? []))
            <div class="flex justify-center items-center h-80 bg-gray-50 dark:bg-gray-700 rounded-lg">
                <div class="text-center p-6">
                    ...
                    <p class="text-gray-400 dark:text-gray-500 mt-2">Select a node and metric to view trend data</p>
                </div>
            </div>
        @else
